@extends('site.layouts.treatament')
                            ...
                            <div class="grid-container full-height">
                                <div class="grid-x full-height grid-padding-x align-middle align-center">
                                    <div class="cell medium-10 text-right">
                                        ...
                                        <a class="section__anchor button rounded-outline" href="#{{ $page->template }}-{{ $index }}" >{{ $treatment->btn_title }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@foreach($page->treatments as $index => $treatment)
    <div class="modal__element" id="{{ $page->template }}-{{ $index }}">
        <div class="grid-container full">
                <div class="grid-x">
